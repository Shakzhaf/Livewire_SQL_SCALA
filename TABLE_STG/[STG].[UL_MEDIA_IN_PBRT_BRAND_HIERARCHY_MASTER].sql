Create table [STG].[UL_MEDIA_IN_PBRT_BRAND_HIERARCHY_MASTER]
(
...
[CRT_DT] [date] NULL,
[CRT_USER] [nvarchar](200) NULL,
[MOD_DT] [date] NULL,
[MOD_USER] [nvarchar](200) NULL
)

DROP table [STG].[UL_MEDIA_IN_PBRT_BRAND_HIERARCHY_MASTER]